...
function App({data_id}) {
    ...
    async function getData(){
        const response = fetch(CategoryApi.concat('tvu'))
        ...
        <div class="row justify-content-center" >
            <div class="col-lg-12">
                <div class="area-heading">
                    <h4>TV Universitaria</h4>
                </div>
                <h3>Programacion Actual</h3>           
            </div>
        </div>
...
if (document.getElementById('tvu_index')) {
    const element =  document.getElementById('tvu_index');
