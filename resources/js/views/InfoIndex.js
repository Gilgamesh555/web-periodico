...
function App({data_id}) {
    ...
    async function getData(pageNumber = 1){
        const response = fetch(CategoryApi.concat('informaciones'))
        .then(res => res.json())
        .then(
            (response) => {
        ...
        <div class="row justify-content-center" >
            <div class="col-lg-12">
                <div class="area-heading">
                    <h4>Informacion Universitaria</h4>
                </div>           
            </div>
        </div>
        <div class="row">
...
if (document.getElementById('info_index')) {
    const element =  document.getElementById('info_index');
